...
## Ne pas demander une génération libre

**« Quel code parmi les 732 ? »**

- Espace **trop large** pour une génération fiable
- **Hallucinations** très fréquentes (codes inexistants)
...
- La table de correspondance donne l'**ensemble des NACE 2025 admissibles** (2–5)
- La tâche devient : **choisir le bon code dans une courte liste fermée**
- Décision **alignée sur les règles officielles**

## Deux façons de fournir les candidats
